...
/** The argument is a matchedIndexLine i.e.: the result of 'EDITOR_getIndexLineToHtml_Correctly'. This returns -1 if you go out of viewport. It will wrap around if you go too large because 'EDITOR_domLineNodesZerothIndex' isn't 0. */
function EDITOR_getIndexLineToHtml_Correctly_NEXT(matchedIndexLine) {
    // TODO
}

/** The argument is a matchedIndexLine i.e.: the result of 'EDITOR_getIndexLineToHtml_Correctly'. This returns -1 if you go out of viewport. It will wrap around if you go too small because 'EDITOR_domLineNodesZerothIndex' isn't 0. */
...
function EDITOR_deleteDo(cursor, event) {
    ...
    if (w.indexColumn_Goal == lastValidIndexColumn) {
        ...
        if (cursor.indexLine < EDITOR_lineEndPositionList.count - 1) {
            ...
            if (cursor.indexLine - get_EDITOR_virtualLineIndex() < get_EDITOR_textElement().children.length &&
                cursor.indexLine - get_EDITOR_virtualLineIndex() >= 0 &&
                cursor.indexLine - get_EDITOR_virtualLineIndex() + 1 < get_EDITOR_textElement().children.length &&
                cursor.indexLine - get_EDITOR_virtualLineIndex() + 1 >= 0) {
                    
                let keepingDiv = get_EDITOR_textElement().children[cursor.indexLine - get_EDITOR_virtualLineIndex()];
                let removingDiv = get_EDITOR_textElement().children[cursor.indexLine - get_EDITOR_virtualLineIndex() + 1];
